...
# brightness and color alone - open the image, and move the numbers to match
...
palette:
  # Colors are clustered out of the image itself. Dropping this toward 16
  ...
  # pattern cannot crawl. 0 turns it off for flat color fields.
  dither: {dither:.2}
...
prepare:
  ...
  # color and tone apart before the palette is chosen.
  saturation: {sat:.2}
  contrast: {con:.2}
...
# interior and a cooler exterior. "chroma" keys on color temperature rather
